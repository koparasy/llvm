//==------- nd_item_core.hpp --- SYCL iteration nd_item core -------------==//
//
...
protected:
  ...
  template <int Dims>
  friend nd_item<Dims> detail::getFreeFunctionQueryNDItem();
  nd_item() {}
...
inline nd_item<Dimensions> getFreeFunctionQueryNDItem() {
#ifdef __SYCL_DEVICE_ONLY__
  return nd_item<Dimensions>{};
#else
