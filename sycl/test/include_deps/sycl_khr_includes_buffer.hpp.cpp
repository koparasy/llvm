...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/buffer.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/buffer.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/buffer.hpp
