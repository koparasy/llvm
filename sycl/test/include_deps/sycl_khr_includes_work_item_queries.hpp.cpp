...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/work_item_queries.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/work_item_queries.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/work_item_queries.hpp
