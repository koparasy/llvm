...
// REQUIRES: linux
// RUN: bash %S/deps_known.sh sycl/khr/includes/stream.hpp | FileCheck %s

// CHECK-LABEL: Dependencies for <sycl/khr/includes/stream.hpp>:
// CHECK-NEXT: /dev/null: /dev/null
// CHECK-NEXT: khr/includes/stream.hpp
