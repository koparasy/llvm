...
static_assert(std::is_same_v<decltype(sycl::islessgreater(sycl::half{1.0f},
                                                          sycl::half{2.0f})),
                             bool>);
static_assert(std::is_same_v<decltype(sycl::isequal(Vec2f{1.0f, 2.0f},
                                                     Vec2f{1.0f, 3.0f})),
                             Vec2i>);
static_assert(std::is_same_v<decltype(sycl::isequal(MArray2f{1.0f, 2.0f},
                                                    MArray2f{1.0f, 3.0f})),
                             MArray2b>);
static_assert(std::is_same_v<decltype(sycl::signbit(Vec2f{-1.0f, 2.0f})),
                             Vec2i>);
static_assert(std::is_same_v<decltype(sycl::signbit(sycl::half{-1.0f})), bool>);
static_assert(std::is_same_v<decltype(sycl::select(Vec2f{1.0f, 2.0f},
                                                    Vec2f{3.0f, 4.0f},
                                                    Vec2i{0, -1})),
                             Vec2f>);
