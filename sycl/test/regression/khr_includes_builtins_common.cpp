...
static_assert(std::is_same_v<decltype(sycl::degrees(sycl::half{1.0f})),
                             sycl::half>);
static_assert(std::is_same_v<decltype(sycl::clamp(Vec2f{0.25f, 1.5f}, 0.0f,
                                                    1.0f)),
                             Vec2f>);
static_assert(std::is_same_v<decltype(sycl::clamp(MArray2f{0.25f, 1.5f}, 0.0f,
                                                  1.0f)),
                             MArray2f>);
...
static_assert(std::is_same_v<decltype(sycl::mix(MArray2f{0.0f, 1.0f},
                             ...
                             MArray2f>);
static_assert(std::is_same_v<decltype(sycl::step(0.5f, Vec2f{0.25f, 0.75f})),
                             Vec2f>);
